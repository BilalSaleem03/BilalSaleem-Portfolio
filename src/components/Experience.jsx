...
const experiences = [
  {
    ...
    description: [
      'Architected scalable RESTful APIs utilizing Nest.js and PostgreSQL to support core backend service features',
      'Engineered predictive data models using Scikit-learn and TensorFlow, integrating machine learning pipelines with backend endpoints',
      'Optimized database queries and schema designs in PostgreSQL, improving data retrieval efficiency during development cycles',
    ],
  },
  {
    ...
    description: [
      'Directed execution operations for COMPETE’24 and COMSATS Tech Summit (CTS), national-level hackathons attracting 500+ participants',
      'Coordinated cross-functional teams handling logistics, technical platform setup, and sponsor relations to ensure seamless event delivery',
    ],
  },
]
